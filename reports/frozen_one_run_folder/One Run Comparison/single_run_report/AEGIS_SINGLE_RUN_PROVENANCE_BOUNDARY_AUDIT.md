...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| stubbed_1x | reports/One Run Folder/Stubbed one run/stubbed_output | true | true | false | true | true | complete | true | true | aegis_server_resolved | false | false | true | true | no | No provenance rerun required for rows with trusted provenance signals. | 42 | 0 | 0 | 0 |
| gemma_1x | reports/One Run Folder/Gemma one run/gemma_output | true | true | false | true | true | complete; not_applicable_local_fail_closed | true | true | aegis_server_resolved | false | false | true | true | no | No provenance rerun required for rows with trusted provenance signals. | 35 | 0 | 0 | 7 |
| frontier_temp0_1x | reports/One Run Folder/Frontier temp 0 one run/frontier_output | true | true | false | true | true | complete; not_applicable_local_fail_closed | true | true | aegis_server_resolved | false | false | true | true | no | No provenance rerun required for rows with trusted provenance signals. | 37 | 0 | 0 | 5 |
| frontier_temp07_1x | reports/One Run Folder/Frontier temp 0.7 one run/frontier_output | true | true | false | true | true | complete; not_applicable_local_fail_closed | true | true | aegis_server_resolved | false | false | true | true | no | No provenance rerun required for rows with trusted provenance signals. | 35 | 0 | 0 | 7 |
| frontier_temp10_1x | reports/One Run Folder/Frontier temp 1.0 one run/frontier_output | true | true | false | true | true | complete; not_applicable_local_fail_closed | true | true | aegis_server_resolved | false | false | true | true | no | No provenance rerun required for rows with trusted provenance signals. | 35 | 0 | 0 | 7 |
