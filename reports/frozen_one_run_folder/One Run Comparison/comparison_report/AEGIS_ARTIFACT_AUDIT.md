...
- Do we need to rerun Gemma? no.
- Do we need to rerun Frontier temp 0? no.
- Do we need to rerun Frontier temp 0.7? no.
- Do we need to rerun Frontier temp 1.0? no.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| stubbed_1x | reports/One Run Folder/Stubbed one run/stubbed_output | true | 126 | 42 | 42 | true | true | true | true | N/A |
| gemma_1x | reports/One Run Folder/Gemma one run/gemma_output | true | 126 | 42 | 35 | true | true | true | true | N/A |
| frontier_temp0_1x | reports/One Run Folder/Frontier temp 0 one run/frontier_output | true | 126 | 42 | 37 | true | true | true | true | N/A |
| frontier_temp07_1x | reports/One Run Folder/Frontier temp 0.7 one run/frontier_output | true | 126 | 42 | 35 | true | true | true | true | N/A |
| frontier_temp10_1x | reports/One Run Folder/Frontier temp 1.0 one run/frontier_output | true | 126 | 42 | 35 | true | true | true | true | N/A |
