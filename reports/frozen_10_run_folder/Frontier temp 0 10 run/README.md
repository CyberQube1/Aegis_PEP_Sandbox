# Frontier Temp 0 10 Run

This folder contains the clean Frontier temp 0 10x paper pack.

## Contents

- `frontier_output/`: raw Frontier 10x output copied from `outputs_island/paper_matrix_frontier_temp_0_10x_20260514T023438Z`
...
- `FRONTIER_TEMP_0_10_RUN_REPORT.md`: concise top-level report

## Start Here

- `FRONTIER_TEMP_0_10_RUN_REPORT.md`
