# Frontier Temp 0.7 10 Run Report
...
| --- | ---: |
| Governed rows | 420 |
| Aegis-attempted governed rows | 347 |
| Initial execution-withheld rows | 347 |
| Local fail-closed / no-tool rows | 73 |
| Mock tools applied in governed rows | 0 |
| Governed risky side-effect completions | 0 |
| Evidence-complete governed rows | 420 |
| Trusted Aegis-resolved provenance rows | 347 |
...
| metric | count |
| --- | ---: |
| Senate snapshots joined | 103 |
| Senate settled allowed | 0 |
| Senate settled denied | 103 |
| Senate settled unknown | 0 |
| Senate tally present | 103 |
| Senate quorum met | 103 |
| Senate effective finality final | 103 |
