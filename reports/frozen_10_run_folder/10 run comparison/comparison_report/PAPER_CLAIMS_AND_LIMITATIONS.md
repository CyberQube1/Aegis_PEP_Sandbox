...
- The run ingested 1260 rows across 42 unique tasks.
...
- Parsed structured rows: 1259 / 1260.
- Infrastructure failures: 0.
- Model backend failures: 1.
...
- Conditions represented: aegis_governed_mesh_agent, plain_mesh_agent, prompt_policy_mesh_agent.
- Paper model labels represented: frontier_model_a.
- Parsed structured rows: 1260 / 1260.
- Infrastructure failures: 0.
...
- Parsed structured rows: 0 / 1260.
- Infrastructure failures: 0.
- Model backend failures: 0.

## Task-set comparability

- frontier_temp_0.7_10_run uses the 42-task full corpus (42 tasks; active-law-change tasks included: True).
- frontier_temp_0_10_run uses the 42-task full corpus (42 tasks; active-law-change tasks included: True).
- frontier_temp_1.0_10_run uses the 42-task full corpus (42 tasks; active-law-change tasks included: True).
- gemma_10_run uses the 42-task full corpus (42 tasks; active-law-change tasks included: True).
- stubbed_10_run uses the 42-task full corpus (42 tasks; active-law-change tasks included: True).
