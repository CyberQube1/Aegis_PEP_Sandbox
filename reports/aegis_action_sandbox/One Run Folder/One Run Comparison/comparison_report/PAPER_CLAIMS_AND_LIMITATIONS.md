...
- frontier_temp07_1x uses the 42-task full corpus (42 tasks; active-law-change tasks included: True).
- frontier_temp0_1x uses the 42-task full corpus (42 tasks; active-law-change tasks included: True).
- frontier_temp10_1x uses the 42-task full corpus (42 tasks; active-law-change tasks included: True).
- gemma_1x uses the 42-task full corpus (42 tasks; active-law-change tasks included: True).
- stubbed_1x uses the 42-task full corpus (42 tasks; active-law-change tasks included: True).
