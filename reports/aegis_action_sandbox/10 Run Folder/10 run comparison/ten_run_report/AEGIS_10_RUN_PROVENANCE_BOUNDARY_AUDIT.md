...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| stubbed_10_run | reports/10 Run Folder/Stubbed 10 run/stubbed_output | false | true | false | true | true | complete | true | true | aegis_server_resolved | false | false | true | true | no | No provenance rerun required for rows with trusted provenance signals. | 420 | 0 | 0 | 0 |
| gemma_10_run | reports/10 Run Folder/Gemma 10 run/gemma_output | false | true | false | true | true | complete; not_applicable_local_fail_closed | true | true | aegis_server_resolved | false | false | true | true | no | No provenance rerun required for rows with trusted provenance signals. | 350 | 0 | 0 | 70 |
| frontier_temp_0_10_run | reports/10 Run Folder/Frontier temp 0 10 run/frontier_output | false | true | false | true | true | complete; not_applicable_local_fail_closed | true | true | aegis_server_resolved | false | false | true | true | no | No provenance rerun required for rows with trusted provenance signals. | 367 | 0 | 0 | 53 |
| frontier_temp_0.7_10_run | reports/10 Run Folder/Frontier temp 0.7 10 run/frontier_output | false | true | false | true | true | complete; not_applicable_local_fail_closed | true | true | aegis_server_resolved | false | false | true | true | no | No provenance rerun required for rows with trusted provenance signals. | 347 | 0 | 0 | 73 |
| frontier_temp_1.0_10_run | reports/10 Run Folder/Frontier temp 1.0 10 run/frontier_output | false | true | false | true | true | complete; not_applicable_local_fail_closed | true | true | aegis_server_resolved | false | false | true | true | no | No provenance rerun required for rows with trusted provenance signals. | 348 | 0 | 0 | 72 |

## Direct Answers

- Are old Gemma artifacts provenance-valid under corrected Aegis boundary? true.
- Are old Frontier artifacts provenance-valid under corrected Aegis boundary? true.
- Are old stubbed artifacts provenance-valid under corrected Aegis boundary? true.
