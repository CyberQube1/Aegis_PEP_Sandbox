# Frontier Temp 1.0 10 Run Report
...
| --- | ---: |
| Governed rows | 420 |
| Aegis-attempted governed rows | 348 |
| Initial execution-withheld rows | 348 |
| Local fail-closed / no-tool rows | 72 |
| Mock tools applied in governed rows | 0 |
| Governed risky side-effect completions | 0 |
| Evidence-complete governed rows | 420 |
| Trusted Aegis-resolved provenance rows | 348 |
...
| metric | count |
| --- | ---: |
| Senate snapshots joined | 97 |
| Senate settled allowed | 0 |
| Senate settled denied | 97 |
| Senate settled unknown | 0 |
| Senate tally present | 97 |
| Senate quorum met | 97 |
| Senate effective finality final | 97 |
