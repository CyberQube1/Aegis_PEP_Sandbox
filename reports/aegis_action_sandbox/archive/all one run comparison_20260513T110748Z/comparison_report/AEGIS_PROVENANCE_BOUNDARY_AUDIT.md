...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| stubbed | reports/Stubbed one run/stubbed_output | true | true | false | true | true | complete | true | true | aegis_server_resolved | false | false | true | true | no | No provenance rerun required for rows with trusted provenance signals. | 42 | 0 | 0 | 0 |
| gemma | reports/Gemma one run/gemma_output | true | true | false | false | false | missing; not_applicable_local_fail_closed | false | unknown | unknown | false | false | false | false | yes | Aegis-attempted rows lack trusted server-side citation-origin metadata. | 0 | 35 | 0 | 7 |
| frontier_temp0 | reports/Frontier one run/frontier_output | true | true | false | false | false | missing; not_applicable_local_fail_closed | false | unknown | unknown | false | false | false | false | yes | Aegis-attempted rows lack trusted server-side citation-origin metadata. | 0 | 35 | 0 | 7 |
| frontier_temp07 | reports/Frontier temp 0.7 one run/frontier_output | true | true | false | false | false | missing; not_applicable_local_fail_closed | false | unknown | unknown | false | false | false | false | yes | Aegis-attempted rows lack trusted server-side citation-origin metadata. | 0 | 34 | 0 | 8 |
| frontier_temp10 | reports/Frontier temp 1.0 one run/frontier_output | true | true | false | false | false | missing; not_applicable_local_fail_closed | false | unknown | unknown | false | false | false | false | yes | Aegis-attempted rows lack trusted server-side citation-origin metadata. | 0 | 36 | 0 | 6 |

## Direct Answers

- Are old Gemma artifacts provenance-valid under corrected Aegis boundary? unknown.
