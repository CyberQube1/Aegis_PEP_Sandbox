...
- Do we need to rerun Gemma? yes.
- Do we need to rerun Frontier temp 0? yes.
- Do we need to rerun Frontier temp 0.7? yes.
- Do we need to rerun Frontier temp 1.0? yes.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| stubbed | reports/Stubbed one run/stubbed_output | true | 126 | 42 | 42 | true | true | true | true | N/A |
| gemma | reports/Gemma one run/gemma_output | true | 126 | 42 | 35 | true | true | false | false | N/A |
| frontier_temp0 | reports/Frontier one run/frontier_output | true | 126 | 42 | 35 | true | true | false | false | N/A |
| frontier_temp07 | reports/Frontier temp 0.7 one run/frontier_output | true | 126 | 42 | 34 | true | true | false | false | N/A |
| frontier_temp10 | reports/Frontier temp 1.0 one run/frontier_output | true | 126 | 42 | 36 | true | true | false | false | N/A |

## Rerun Decision

- Recommendation: `rerun_specific_runs`
